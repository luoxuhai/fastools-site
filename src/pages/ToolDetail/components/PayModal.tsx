...
export default connect(({ login }: any) => ({ ...login }))(
  ({ tool: { _id, price }, visibleInput, onHidePayModal, onHideInput }: any) => {
            ...
            <div className={styles.QRcodePay}>
              ...
              <div className={styles.payInfo}>
                ...
                <p>
                  客服QQ群:
                  <a
                    href="//shang.qq.com/wpa/qunwpa?idkey=a8b4e205ac4b58351e1b8acdf672be7ee82f724d627429704279ca78596775ff"
                    target="_blank"
                  >
                    617853966
                  </a>
